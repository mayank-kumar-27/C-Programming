// Develop a program that simulates a simple banking system where users can deposit, withdraw, and check their balance
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
int main()
